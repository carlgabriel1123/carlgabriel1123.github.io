...
// ── Updated seo.liquid ───────────────────────────────────────────────────────
const seoLiquid = `{%- comment -%} SEO meta tags — canonical, OG, Twitter {%- endcomment -%}
...
// ── New schema.liquid ────────────────────────────────────────────────────────
const schemaLiquid = `{%- comment -%} JSON-LD Structured Data {%- endcomment -%}
...
const [r1, r2] = await Promise.all([
  putAsset("snippets/seo.liquid", seoLiquid),
  putAsset("snippets/schema.liquid", schemaLiquid),
]);
console.log(r1);
console.log(r2);
